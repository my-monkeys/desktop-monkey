...
case "$SCENE" in
  ...
  jetbord)   KV='"chance_ami":1,"distance_arret":150,"chance_crotte":0.4,"chance_jet_crotte":3.0,"jet_mode":0,"secondes_avant_vie_seule":2' ;;
  jetsouris) KV='"chance_ami":1,"distance_arret":170,"chance_crotte":0.4,"chance_jet_crotte":3.0,"jet_mode":1,"secondes_avant_vie_seule":2' ;;
